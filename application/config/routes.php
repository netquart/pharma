...
$route['admin/products/UpdateStock'] = 'admin/ecommerce/products/UpdateStock';
...
$route['admin/addbrands'] = "admin/ecommerce/addbrands";

$route['admin/addcoupons'] = "admin/ecommerce/addcoupons";

$route['admin/saleoffers'] = "admin/ecommerce/saleoffers";

$route['admin/addsaleoffers'] = "admin/ecommerce/addsaleoffers";

$route['admin/adddeliverymethods'] = "admin/ecommerce/adddeliverymethods";

$route['admin/deliverymethods'] = "admin/ecommerce/deliverymethods";

$route['admin/clubcards'] = "admin/ecommerce/clubcards";

$route['admin/listpages'] = "admin/ecommerce/listpages";

$route['admin/cmscontent'] = "admin/ecommerce/cmscontent";

$route['admin/addcmscontent'] = "admin/ecommerce/addcmscontent";

$route['admin/addcmscontent/(:num)'] = "admin/ecommerce/addcmscontent/index/$1";

$route['admin/addsplashpage'] = "admin/ecommerce/addsplashpage";

$route['admin/addsplashpage/(:num)'] = "admin/ecommerce/addsplashpage/index/$1";

$route['admin/addtestimonials/(:num)'] = "admin/ecommerce/addtestimonials/index/$1";

$route['admin/addtestimonials'] = "admin/ecommerce/addtestimonials";


$route['admin/addfaqs/(:num)'] = "admin/ecommerce/addfaqs/index/$1";

$route['admin/addfaqs'] = "admin/ecommerce/addfaqs";


$route['admin/splashpage'] = "admin/ecommerce/splashpage";
$route['admin/testimonials'] = "admin/ecommerce/testimonials";
$route['admin/reviews'] = "admin/ecommerce/reviews";
$route['admin/listfaqs'] = "admin/ecommerce/listfaqs";

$route['admin/addcategory'] = "admin/ecommerce/addcategory";

$route['admin/addcouponcode'] = "admin/ecommerce/addcouponcode";

$route['admin/listcouponcode'] = "admin/ecommerce/listcouponcode";

$route['admin/listcoupons'] = "admin/ecommerce/listcoupons";
$route['admin/addcoupons2'] = "admin/ecommerce/addcoupons2";
$route['admin/addcategory/(:num)'] = "admin/ecommerce/addcategory/index/$1";

$route['admin/addbrands/(:num)'] = "admin/ecommerce/addbrands/index/$1";

$route['admin/addcoupons/(:num)'] = "admin/ecommerce/addcoupons/index/$1";

$route['admin/addsaleoffers/(:num)'] = "admin/ecommerce/addsaleoffers/index/$1";

$route['admin/addpage/(:num)'] = "admin/ecommerce/addpage/index/$1";

$route['admin/addpage'] = "admin/ecommerce/addpage";


$route['admin/adddeliverymethods/(:num)'] = "admin/ecommerce/adddeliverymethods/index/$1";

$route['admin/addcoupons2/(:num)'] = "admin/ecommerce/addcoupons2/index/$1";
$route['admin/brands/(:num)'] = "admin/ecommerce/brands/index/$1";
// BLOG GROUP
